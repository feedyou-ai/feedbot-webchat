...
const localizedStrings: LocalizedStrings = {
    'en-us': {
        ...
        speak: "Speak",
        uploadFileFailedSize: "The file is too large to upload. The maximum allowed size is 4 MB. Please choose a smaller file.",
    ...
    'cs-cz': {
        ...
        speak: "Použít hlas",
        uploadFileFailedSize: 'Soubor je pro nahrání příliš velký. Maximální povolená velikost je 4 MB. Vyberte prosím menší soubor.',
